...
print("\n-Classic mode or benchmarking ? (classic | bench_auto)")
a=raw_input()
  
if(a=='bench_auto' and len(way)==1):# Benchmarking mode -----------
 ...
 for i in range(0,nb):
  ...
  l,repeatability=Instance.precision_on_pose([0.3,-0.1,0.25,0,0,0])
